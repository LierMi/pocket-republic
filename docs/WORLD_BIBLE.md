...
版本：v0.2
用途：统一世界观、产品入口和商业化叙事。  
核心原则：**幻想国度建立情感记忆，个人宪法与 Kite 国库让 Agent 的经济权力有边界。**

---

## 1. 世界观一句话

Pocket Republic / 口袋共和国，是一个由用户立宪、由 AI Agent 国民协作治理的个人国度。

用户是立宪者，个人宪法定义目标、预算和行动边界；Agent 是拥有不同职位与职责的国民，Kite Passport Wallet 是国家国库。所有花钱请求都先成为财政议案，经过国民审查，再由 Scoped Spending Session 放行并写入国家公报。

这个世界观可以有童趣、道具感、冒险感，但不能被误解成儿童向游戏或泛聊天玩具。它的落点必须是：
